...
export default function AuthPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast.error(message || 'Failed to start Google authentication')
    } finally {
  ...
  const isBackendStarting = isBackendChecking || !isBackendReady
  ...
  return (
    <div className="relative flex-1 min-h-0 bg-[hsl(var(--gray-50))] dark:bg-background overflow-hidden">
      ...
      <p className="absolute bottom-8 left-0 right-0 text-app-caption text-muted-foreground text-center px-6 leading-relaxed">
        By continuing you grant access to Gmail, Calendar, Drive, Docs, and Sheets.
      </p>
    </div>
  )
}
