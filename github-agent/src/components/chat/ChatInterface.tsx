    ...
    <>
      ...
      >
        <AlertDialogContent onEscapeKeyDown={(e) => e.preventDefault()}>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {oauthPermissionError?.label ?? 'GitHub'} permission required
            </AlertDialogTitle>
            <AlertDialogDescription>
              {oauthPermissionError?.message ??
                'This action needs a GitHub permission you did not grant. Re-authenticate to grant access.'}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleGrantOAuthPermission} disabled={isReauthing}>
              {isReauthing ? 'Waiting for GitHub…' : 'Grant permission on GitHub'}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
